...
layout: uikit-single
title: Event
description: "The VCardEvent component is a versatile card designed for displaying article information, including a publish date, title, description, and an optional cover image."
slug: card-event
draft: false
